...
drag_area_main = mass*GRAVITY/(0.5*1.225*final_v**2)

new_mainpara = Mainpara(0.5, 5e2, drag_area_main/0.5, 20)          # conical ribbon parachute
new_rocket = Rocket(0.55, 80.0, 0.02)               # cd0 rocket, mass of rocket, cross-section
new_drogue = Drogue(0.35, 6e3, 0.2, 25)            # cd0 drogue, altitude of deployment, surface of chute, total porosity
